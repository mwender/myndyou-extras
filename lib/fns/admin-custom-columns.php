...
namespace myndyou\customcolumns;
...
function set_team_member_edit_columns($columns) {
  $columns['photo']       = __( 'Photo', 'myndyou' );
  $columns['email']       = __( 'Email', 'myndyou' );
  $columns['staff_type']  = __( 'Staff Type(s)', 'myndyou' );
  $columns['title']       = __( 'Name', 'myndyou' );
