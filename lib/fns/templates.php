<?php
namespace myndyou\fns\templates;
...
function render_template( $filename = '', $data = [] ){
  ...
  $theme_template = \trailingslashit( $theme_path ) . 'myndyou-templates/' . $filename . '.hbs';
  $theme_template_compiled = \trailingslashit( $theme_path ) . 'myndyou-templates/compiled/' . $filename . '.php';

  $plugin_template = trailingslashit( MYDU_PLUGIN_PATH ) . 'lib/templates/' . $filename . '.hbs';
  $plugin_template_compiled = \trailingslashit( MYDU_PLUGIN_PATH ) . 'lib/templates/compiled/' . $filename . '.php';
